"""
Nombre del ejercicio: Quiz básico

Instrucciones:
Crea un quiz de dos preguntas con opciones múltiples y utiliza una estructura de control para indicar al programa que hacer cuándo la respuesta es correcta, cuando es incorrecta o cuando no es una opción valida 

Criterios de calidad:
1.- El programa debe permitir la interacción con el usuario 
2.- El programa debe incorparar al menos un manejo de errores
3.- El programa debe permitir que el usuario sume puntos por cada respuesta correcta. La solución del código uede ser elemental o poco sofisticada.
...
#Se la información relacionada con la pregunta número 1 del quiz
...
#Con las estructuras if,elif,else evaluaremos si el usuario a ingresado una respuesta valida 
if q1 == respuesta_q1:
